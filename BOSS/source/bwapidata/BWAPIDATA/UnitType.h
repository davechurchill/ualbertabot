...
namespace BWAPIDATA
{
  ...
  class UnitType
  {
    public:
      ...
      /** Returns the amount of supply used by this unit. Supply counts returned by BWAPIDATA are double what you
       ...
       * returned by BWAPIDATA are double what you would expect to see from playing the game. This is because
