...
namespace BWAPIDATA
{
  ...
  /** The abstract Game class is implemented by BWAPIDATA and offers many methods for retrieving information
  ...
  class Game
  {
    public :
       ...
       * disabled. */
      virtual BWAPIDATA::Position getMousePosition() = 0;
      ...
      virtual BWAPIDATA::Position getScreenPosition() = 0;
       ...
       * lurkers, BWAPIDATA will set error codes, which can be retrieved using this function. */
      virtual Error getLastError() const = 0;

      /** Sets the last error code. */
      virtual bool setLastError(BWAPIDATA::Error e) = 0;
      ...
      */
      ...
      /** Returns a pointer to the player that BWAPIDATA controls. In replays this will return null. */
      ...
      /** Retrieves the current revision of BWAPIDATA. */
      virtual int getRevision() = 0;

      /** Retrieves the debug state of the BWAPIDATA build. */
      ...
      /** Retrieves the instance number recorded by BWAPIDATA to identify which instance an AI module belongs to */
