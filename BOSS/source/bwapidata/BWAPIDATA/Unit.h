...
namespace BWAPIDATA
{
   ...
   * particular unit, BWAPIDATA checks to see if Flag::CompleteMapInformation? is enabled. So there are two cases
   ...
   * AI must watch for AIModule::onUnitDestroy messages from BWAPIDATA, which is only called for visible units
   * which get destroyed.
   *
