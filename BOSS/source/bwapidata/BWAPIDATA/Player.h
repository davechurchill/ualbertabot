...
namespace BWAPIDATA
{
  ...
  class Player
  {
    public :
       ...
       * by BWAPIDATA are double what you would expect to see from playing the game. This is because zerglings
       ...
       * counts returned by BWAPIDATA are double what you would expect to see from playing the game. This is
      ...
      virtual BWAPIDATA::Color getColor() const = 0;
