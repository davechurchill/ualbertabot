...
namespace BWAPIDATA
{
  ...
  {
    private :
      int addShape(BWAPIDATAC::Shape &s);
      int addString(const char* text);
      int addText(BWAPIDATAC::Shape &s, const char* text);
      int addCommand(BWAPIDATAC::Command &c);
      void clearAll();
    ...
    public :
      Event makeEvent(BWAPIDATAC::Event e);
      int addUnitCommand(BWAPIDATAC::UnitCommand& c);
      bool inGame;
      ...
      virtual BWAPIDATA::Position getMousePosition();
      ...
      virtual BWAPIDATA::Position getScreenPosition();
      virtual void setScreenPosition(int x, int y);
      virtual void setScreenPosition(BWAPIDATA::Position p);
      virtual void pingMinimap(int x, int y);
      virtual void pingMinimap(BWAPIDATA::Position p);
      ...
      virtual bool  setLastError(BWAPIDATA::Error e);
      ...
      virtual void changeRace(BWAPIDATA::Race race);
      ...
      virtual std::set<BWAPIDATA::Unit*>& getSelectedUnits();
      virtual Player*  self();
