...
namespace BWAPIDATA
{
  ...
  class UpgradeTypeInternal
  {
    public:
      ...
      void set(const char* name, int mineralPriceBase, int mineralPriceFactor, int gasPriceBase, int gasPriceFactor, int upgradeTimeBase, int upgradeTimeFactor, BWAPIDATA::UnitType whatUpgrades, Race race, BWAPIDATA::UnitType whatUses, int maxRepeats)
      {
      ...
      BWAPIDATA::UnitType whatUpgrades;
      Race race;
      int maxRepeats;
      std::set<BWAPIDATA::UnitType> whatUses;
      bool valid;
  };
