...
namespace Config
{
    namespace ConfigFile
    {
        ...
        std::string ConfigFileLocation      = "C:/Users/Tarek/Documents/GitHub/ualbertabot/UAlbertaBot/UAlbertaBot_Config.txt";//"bwapi-data/AI/UAlbertaBot_Config.txt";
    }

    namespace Strategy
    {
        std::string ProtossStrategyName     = "ProtossTBJY";
        std::string TerranStrategyName      = "Terran_MarineRush";
        std::string ZergStrategyName        = "Zerg_3HatchMuta";
        std::string StrategyName            = "ProtossTBJY";
    ...
    namespace BotInfo
    {
        std::string BotName                 = "ProtossTBJY";
        std::string Authors                 = "Boyan Peychoff, Tarek EI Bohtimy, Jeremy Nguyen, Yufei Zhang";
