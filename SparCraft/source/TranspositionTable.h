...
public:
	...
	const TTBestMove & getBestMove(const PlayerID & player)		const;
	void setBestMove(const PlayerID &firstPlayer, const AlphaBetaMove & bestFirstMove, const AlphaBetaMove & bestSecondMove);
