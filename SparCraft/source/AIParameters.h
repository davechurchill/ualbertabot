...
{   
    ...
    PlayerPtr           parsePlayer(const IDType & player, const std::string & playerVariable, const rapidjson::Value & root);
...
public:
    ...
    PlayerPtr           getPlayer(const IDType & player, const std::string & playerName);
